 ...
 */
public class Manager extends Employee implements ICalculable {

    public Manager(float salary, float bonusPercentage, float bonus) {
    ...
    public float calcularSalario(int month){
        float valueM = salary + (bonusPercentage * bonus);
    ...
    public String toString() {
         return "Manager{" + "rmu=" + rmu + ", salary=" + salary + ", bonusPercentage=" + bonusPercentage + ", bonus=" + bonus + '}';
    }
}
